...
Представленная библиотека алгоритмов компьютерного зрения адаптированна для создания морских робототехнических комплексов (автономные необитаемые подводные аппараты, стационарные подводные робототехнические комплексы). 

Библиотека в первую очередь предназначена для разработчиков роботизированных систем морского назначения.

В тоже время, библиотека может полезна разработчикам наземных и воздушных роботизированных систем, оснащенными системами компьютерного зрения (роботы доставщики, беспилотные автомобили, дроны, другие автономные подвижные объекты).
